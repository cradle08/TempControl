...
#define  APP_CFG_TASK_UART_PRIO					5u
#define  APP_CFG_TASK_MAIN_HANDLE_PRIO			6u
...
#define  APP_CFG_TASK_UART_STK_SIZE				1024u
#define  APP_CFG_TASK_MAIN_HANDLE_STK_SIZE		1024u
...
#define  APP_SERIAL_CFG_TRACE_PORT_NAME         "USART7"
